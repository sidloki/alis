...
System.register('alis/services/search.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js', 'aurelia-framework', './db'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export('Search', Search = (_dec = inject(Database), _dec(_class = function () {
        function Search(db) {
        ...
        _createClass(Search, [{
          ...
          value: function execute(text) {
            ...
            for (var i = 0; i < this.db.data.locations.length; i++) {
              var location = this.db.data.locations[i];
            ...
            var _loop = function _loop(_i2) {
              var building = _this.db.data.buildings[_i2];
              ...
              building.rooms.forEach(function (room) {
                var roomType = _this.db.data.roomtypes.find(function (item) {
            ...
            for (var _i2 = 0; _i2 < this.db.data.buildings.length; _i2++) {
              var _ret = _loop(_i2);
...
System.register('alis/pages/home.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js', 'onsenui', 'aurelia-router', 'aurelia-framework', '../services/db', '../services/search', '../services/storage'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, ons, Router, inject, bindable, Database, Search, Storage, _dec, _class, _desc, _value, _class2, _descriptor, _descriptor2, Home;
  ...
  return {
    ...
    }, function (_servicesSearch) {
      Search = _servicesSearch.Search;
    }, function (_servicesStorage) {
      Storage = _servicesStorage.Storage;
    }],
    execute: function () {
      _export('Home', Home = (_dec = inject(Router, Database, Storage, Search), _dec(_class = (_class2 = function () {
        function Home(router, db, storage, search) {
        ...
        _createClass(Home, [{
          ...
          value: function attached() {
            ...
            this.db.loadData().then(function () {
              _this.buildings = _this.db.data.buildings;
              _this.categories = _this.db.data.roomtypes;
          ...
          key: 'onBuildingDoubleClick',
          value: function onBuildingDoubleClick(e) {
            this.selection = e.layer.data;
          ...
          value: function selectionChanged(newValue, oldValue) {
            ...
            if (newValue) {
              (function () {
                ...
                _this2.markers.addLayer(marker);
                _this2.roomlist.scrollTop = 0;
                setTimeout(function () {
                  _this2.map.invalidateSize({
                    pan: false
                  });
                  if (!_this2.map.getBounds().contains(marker.getLatLng())) {
                    _this2.locateControl._onDrag();
                    _this2.map.setView(marker.getLatLng(), _this2.map.getZoom());
          ...
          set: function set(value) {
            ...
            value.forEach(function (building) {
              ...
              var marker = L.marker([building.lat, building.lng], { icon: icon });
              marker.data = building;
              _this4.buildingsLayer.addLayer(marker);
            });
          },
          get: function get() {
      ...
      _export('Info', Info = (_dec = inject(Router, Database), _dec(_class = function () {
        ...
        _createClass(Info, [{
          ...
          value: function activate(params) {
            ...
            return this.db.loadData().then(function () {
              var id = parseInt(params.id);
              _this.data = _this.db.data.systems.find(function (item) {
                return item.id === id;
              });
            });
          }
          ...
          value: function getRoomName() {
            ...
            if (!name) {
              var type = this.db.data.roomtypes.find(function (type) {
                return type.typID === _this2.data.typID;
              });
              name = type.typ;
            }
            return name;
          ...
          value: function getTechName() {
            ...
            var technology = this.db.data.technologies.find(function (type) {
              return type.techID === _this4.data.techID;
            });
...
System.register('alis/models/building.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, Building;
  ...
  return {
    ...
    execute: function () {
      _export('Building', Building = function () {
      ...
      _export('Building', Building);
    }
  };
});
System.register('alis/models/canton.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, Canton;
  ...
  return {
    ...
    execute: function () {
      _export('Canton', Canton = function () {
        function Canton(data) {
          _classCallCheck(this, Canton);
      ...
      _export('Canton', Canton);
    }
  };
});
System.register('alis/models/location.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, Location;
  ...
  return {
    ...
    execute: function () {
      _export('Location', Location = function () {
...
System.register('alis/models/organisation.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, Organisation;
  ...
  return {
    ...
    execute: function () {
      _export('Organisation', Organisation = function () {
      ...
      _export('Organisation', Organisation);
    }
  };
});
System.register('alis/models/room-type.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, RoomType;
  ...
  return {
    ...
    execute: function () {
      _export('RoomType', RoomType = function () {
        function RoomType(data) {
          _classCallCheck(this, RoomType);

          Object.assign(this, data);
        }

        _createClass(RoomType, [{
          key: 'id',
          get: function get() {
            return this.typID;
          }
      ...
      _export('RoomType', RoomType);
    }
  };
});
System.register('alis/models/system.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, System;
  ...
  return {
    ...
    execute: function () {
      _export('System', System = function () {
      ...
      _export('System', System);
    }
  };
});
System.register('alis/models/technology.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, Technology;
  ...
  return {
    ...
    execute: function () {
      _export('Technology', Technology = function () {
      ...
      _export('Technology', Technology);
    }
  };
});
System.register('alis/services/db.js', ['node_modules/systemjs-plugin-babel/babel-helpers/classCallCheck.js', 'node_modules/systemjs-plugin-babel/babel-helpers/createClass.js', 'aurelia-fetch-client', '../models/building', '../models/canton', '../models/location', '../models/organisation', '../models/room-type', '../models/system', '../models/technology'], function (_export, _context) {
  "use strict";

  var _classCallCheck, _createClass, HttpClient, Building, Canton, Location, Organisation, RoomType, System, Technology, Database;
  ...
  return {
    ...
    }, function (_modelsBuilding) {
      Building = _modelsBuilding.Building;
    }, function (_modelsCanton) {
      Canton = _modelsCanton.Canton;
    }, function (_modelsLocation) {
      Location = _modelsLocation.Location;
    }, function (_modelsOrganisation) {
      Organisation = _modelsOrganisation.Organisation;
    }, function (_modelsRoomType) {
      RoomType = _modelsRoomType.RoomType;
    }, function (_modelsSystem) {
      System = _modelsSystem.System;
    }, function (_modelsTechnology) {
      Technology = _modelsTechnology.Technology;
    }],
    execute: function () {
      _export('Database', Database = function () {
        ...
        _createClass(Database, [{
          ...
          value: function loadData() {
            ...
            var models = [Canton, RoomType, System, Technology];
            if (force === true || Object.keys(this.data).length === 0) {
              this.resetData();
              return Promise.all(models.map(function (model) {
                var tablename = model.tablename;
                return _this.http.fetch('table=' + tablename).then(function (response) {
                  return response.json();
                }).then(function (data) {
                  _this.data[tablename] = data.results.map(function (result) {
          ...
          value: function processData() {
            var systems = this.data[System.tablename];
            var cantons = this.data[Canton.tablename];
            var buildings = {};
            var locations = {};
            var organisations = {};
            ...
            systems.forEach(function (system) {
              ...
              var building = buildings[system.gebaeudeID];
              var location = locations[system.locationID];
              ...
              if (!building) {
                building = new Building({
                  ...
                  plz: system.plz,
                  ort: system.ort,
                  kanton: cantons.find(function (item) {
              ...
              var organisation = building.organisations.find(function (item) {
                return item.id === system.organisationID;
              });
              if (!organisation) {
            ...
            this.data[Building.tablename] = Object.keys(buildings).map(function (key) {
              return buildings[key];
            });
            this.data[Location.tablename] = Object.keys(locations).map(function (key) {
              return locations[key];
            });
            this.data[Organisation.tablename] = Object.keys(organisations).map(function (key) {
          ...
          value: function queryBuildingsByRoomType(roomType) {
            var buildings = [];
            return this.data.buildings.reduce(function (acc, building) {
              var rooms = building.rooms.filter(function (room) {
                return room.typID === roomType.typID;
              });
              if (rooms.length > 0) {
                (function () {
                  var buildingCopy = new Building(building);
                  buildingCopy.rooms = rooms;
                  buildingCopy.organisations = [];
                  building.organisations.forEach(function (organisation) {
                    var rooms = organisation.rooms.filter(function (room) {
                      return room.typID === roomType.typID;
                    });
                    if (rooms.length > 0) {
                      var organisationCopy = new Organisation(organisation);
        ...
        _createClass(Plan, [{
          ...
          value: function activate(params) {
            ...
            return this.db.loadData().then(function () {
              ...
              _this.plans = [];
              if (_this.data.plan1_dateiname !== 'transp.png') {
                (function () {
                  var plan = {
              ...
              if (_this.data.plan2_dateiname !== 'transp.png') {
                (function () {
                  var plan = {
